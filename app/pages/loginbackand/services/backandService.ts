...
export class BackandService {
    ...
    app_name:string = 'bhxh';
    signUpToken: string = 'f13323b4-b913-46c7-9966-4ac9df8df7f4';
    anonymousToken: string = 'e7ada001-874c-4567-9acb-1f0f0b8cd94e';
    auth_status:string = '';
    auth_type:string;
    ...
    public postItem(name, description) {
        ...
        return this.http.post(this.api_url + '/1/objects/items', data,
            {
                headers: this.authHeader
            })
            .retry(3)
    ...
    public getItems() {
        return this.http.get(this.api_url + '/1/objects/items', {
                headers: this.authHeader
            })
            .retry(3)
